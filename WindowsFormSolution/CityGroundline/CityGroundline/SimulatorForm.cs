...
namespace CityGroundline
{
    public partial class SimulatorForm : Form
    {
        ...
        {
            testAi.findAPath4((Road)_mySimulatorMgr.MyCity.MyConstructions[0], (Road)_mySimulatorMgr.MyCity.MyConstructions[128]);
            Graphics gg = pnlCanvas.CreateGraphics();
            Road Rstart, Rend;
            Rstart = (Road)_mySimulatorMgr.MyCity.MyConstructions[0];
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            _mySimulatorMgr.MyCity.MyVehicles.Add(new CivilianVehicle(_mySimulatorMgr.MyCity.MyConstructions[0]));
            _mySimulatorMgr.MyCity.MyVehicles.Add(new PoliceVehicle(_mySimulatorMgr.MyCity.MyConstructions[1]));
